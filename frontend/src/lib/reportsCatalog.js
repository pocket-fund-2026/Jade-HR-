...
// Shared between Reports.jsx (the report hub grid) and AdminLayout.jsx (the
// sidebar section search) — one source of truth for "every report page that
// exists", so a new report only needs adding here to show up in both.
